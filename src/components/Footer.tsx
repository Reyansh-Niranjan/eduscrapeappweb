        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                href="https://www.linkedin.com/company/eduscrapeapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="EduScrapeApp on LinkedIn"
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center opacity-80"
                whileHover={{ scale: 1.1, backgroundColor: '#8B5CF6' }}
                transition={{ duration: 0.2 }}
              >
              ...
              <motion.a
                href="https://x.com/eduscrapeapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="EduScrapeApp on X"
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center opacity-80"
                whileHover={{ scale: 1.1, backgroundColor: '#8B5CF6' }}
                transition={{ duration: 0.2 }}
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <motion.a
                  href="mailto:hello@eduscrapeapp.com"
                  className="transition-colors"
                  style={{ color: 'var(--theme-text-secondary)' }}
                  whileHover={{ color: '#14B8A6', x: 5 }}
                  transition={{ duration: 0.2 }}
                >
                  hello@eduscrapeapp.com
                </motion.a>
              </li>
              <li>
                <motion.a
                  href="https://discord.gg/eduscrapeapp"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors"
                  style={{ color: 'var(--theme-text-secondary)' }}
