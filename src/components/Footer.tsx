export default function Footer() {
  return (
    <footer className="relative py-12 border-t border-purple-500/30">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300 opacity-50">Email (Coming Soon)</li>
              <li className="text-gray-300 opacity-50">Discord (Coming Soon)</li>
            </ul>
          </div>
        </div>
