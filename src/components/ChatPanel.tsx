    ...
    <div className="fixed bottom-6 right-6 w-80 h-[500px] bg-gradient-to-br from-purple-900/95 to-teal-900/95 backdrop-blur-lg border border-purple-500/30 rounded-2xl shadow-2xl z-40 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-purple-500/30">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm">Celestial Coders AI</h3>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-300 text-sm mb-2">Welcome to Celestial Coders AI!</p>
            <p className="text-gray-400 text-xs">Ask me about our team, projects, or anything else!</p>
          </div>
        ) : (
