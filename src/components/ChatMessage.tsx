...
export default function ChatMessage({ role, content, timestamp }: ChatMessageProps) {
  ...
  return (
    <div className={`flex ${isUser ? 'justify-end' : 'justify-start'} mb-4`}>
      ...
      {/* Avatar */}
      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${isUser ? 'bg-gradient-to-r from-teal-500 to-purple-600 order-1 ml-2' : 'bg-gradient-to-r from-purple-600 to-teal-500 order-2 mr-2'
        }`}>
        {isUser ? (
